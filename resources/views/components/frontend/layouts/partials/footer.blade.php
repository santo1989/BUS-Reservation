    ...
    <div class="footer-lower"> 
        ...
        <div class="media-container-row mbr-white">
          ...
          <div class="col-sm-12"> 
            ...
            <p class="text-white text-decoration-none d-flex justify-content-between" style="font-family: 'Inconsolata', monospace; "> © Copyright 2018-{{ now()->year }} Phantom Tranzit LLC- All Rights Reserved 
